...
import 'test_depression_bipolar_controller.dart';

class DepressionBipolarTest extends StatelessWidget {
  const DepressionBipolarTest({super.key});

  @override
  Widget build(BuildContext context) {
    final DepressionBipolarController getQuesAndAns =
        Get.put(DepressionBipolarController());
